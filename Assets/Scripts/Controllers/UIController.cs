...
{
    [HideInInspector] public TouchCanvas touchCanvas;

    private void Start()
    {
        touchCanvas = FindObjectOfType<TouchCanvas>();
        if (touchCanvas == null) throw new NullReferenceException("No TouchCanvas in the scene");
    }
